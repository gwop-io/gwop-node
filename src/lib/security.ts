...
export function resolveGlobalSecurity(security: Partial<models.Security> | null | undefined): SecurityState | null {
  return resolveSecurity([
    {
      fieldName: "Authorization",
      type: "http:bearer",
      value: security?.merchantApiKey ?? env().GWOP_MERCHANT_API_KEY,
    },
  ]);
}
