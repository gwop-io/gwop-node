 ...
 */
export function invoicesCancel(
  client: GwopCore,
  request: operations.CancelInvoiceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CancelInvoiceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CancelInvoiceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/invoices/{id}/cancel")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CancelInvoiceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
