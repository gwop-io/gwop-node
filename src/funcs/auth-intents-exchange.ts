 ...
 */
export function authIntentsExchange(
  client: GwopCore,
  request: operations.ExchangeAuthIntentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExchangeAuthIntentResponse,
...
> {
  ...
  const pathParams = {
    auth_intent_id: encodeSimple("auth_intent_id", payload.auth_intent_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "exchangeAuthIntent",
    oAuth2Scopes: null,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "402", "403", "404", "409", "429", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExchangeAuthIntentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([401, 402, 403, 404], errors.ErrorResponse$inboundSchema, {
      hdrs: true,
    }),
